...
\begin{itemize}
    ...
    \item there are n total tuples of the form $(x_i,y_i)$ in our dataset thus $g=$ \begin{pmatrix}\frac{\partial \ell(y_i, f(x_1))}{\partial f(x_i)}\\\cdots\\\frac{\partial \ell(y_i, f(x_i))}{\partial f(x_n)}
