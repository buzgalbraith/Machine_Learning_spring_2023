...
w_hat=w=fit_logistic_reg( X=X_train, y=y_train,objective_function=f_objective )
...
w_hat=fit_logistic_reg( X=X_train, y=y_train,objective_function=f_objective, l2_param=0.02857151428571429)
