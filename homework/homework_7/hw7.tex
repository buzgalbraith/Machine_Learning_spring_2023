...
\begin{itemize}
    ...
    \item           \inputminted[firstline=119, lastline=144, breaklines=True]{python}{hw7.py}
    \item here is my result as well\\ \includegraphics[width = 15cm]{homework_code/hw7/immages/hw_7_1.JPG}
\end{itemize}
...
\begin{itemize}
    \color{blue}
    \item           \inputminted[firstline=147, lastline=175, breaklines=True]{python}{hw7.py}
...
\begin{itemize}
    \color{blue}
    \item \inputminted[firstline=307, lastline=326, breaklines=True]{python}{hw7.py}
...
\begin{itemize}
    \color{blue}
        \item \inputminted[firstline=177, lastline=214, breaklines=True]{python}{hw7.py}
...
\begin{itemize}
    \color{blue}
    \item \inputminted[firstline=217, lastline=237, breaklines=True]{python}{hw7.py}
...
\begin{itemize}
    \color{blue}
    \item \inputminted[firstline=418, lastline=449, breaklines=True]{python}{hw7.py}
...
\inputminted[firstline=241, lastline=267, breaklines=True]{python}{hw7.py}

\item here is my output\\
\includegraphics[width=15cm]{homework_code/hw7/immages/hw7_13.png}
\end{itemize}
...
\inputminted[firstline=270, lastline=297, breaklines=True]{python}{hw7.py}
\end{itemize}
...
\inputminted[firstline=548, lastline=572, breaklines=True]{python}{hw7.py}
\item i could not get this last question working but i hope the effort is worth partial credit 
